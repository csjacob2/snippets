# Question
**_ You are provided the `flip` function:  
You must implement a `randomNumber(n)` function that generates a random number greater than or equal to 0, and less than input n. _**
